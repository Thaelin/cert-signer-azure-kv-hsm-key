 ...
 * @param validityDaysExplicit Flag indicating whether {@code validityDays} was explicitly provided via CLI.
 */
public record CertSignerConfig(
    ...
    String kvKeyName,
    String kvKeyVersion,
    boolean validityDaysExplicit
) {
    /**
     * Secondary constructor for backward compatibility, automatically determining
     * whether {@code validityDays} was explicitly provided based on non-nullity.
     */
    public CertSignerConfig(
        String outputCertPath,
        String certCsrPath,
        String certSubjectDn,
        String certPublicKeyPath,
        ...
        this(outputCertPath, certCsrPath, certSubjectDn, certPublicKeyPath, certAttributes, validityDays, kvName, kvKeyName, kvKeyVersion, validityDays != null);
    }
}
